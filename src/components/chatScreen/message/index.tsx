	...
	return (
		...
		>
			...
			<View style={styles.metaRow}>
				{isMe && isLast && !seen ? (
					<>
						<Animated.Text exiting={zoomAnimationOut} entering={zoomAnimationIn} key="message-arrived" style={styles.metaRowText}>Доставлено</Animated.Text>
						<View style={styles.metaRowSeparator} />
					</>
				) : null}
				{isMe && seen ? (
					<>
						<Animated.Text exiting={zoomAnimationOut} entering={zoomAnimationIn} key="message-seen" style={styles.metaRowText}>Просмотрено</Animated.Text>
						<View style={styles.metaRowSeparator} />
					</>
				) : null}
